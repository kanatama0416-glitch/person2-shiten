...
const profileHtml = `</h1><div class="creator-signature" aria-label="この視点を書いた人"><div class="creator-spine creator-spine--name"><span class="creator-spine__label">名前</span><div class="creator-spine__text">むらかみ</div>${profileEye}</div><div class="creator-spine creator-spine--role"><span class="creator-spine__label">所属</span><div class="creator-spine__text">カード事業部</div>${profileEye}</div><div class="creator-spine creator-spine--role creator-spine--role-alt"><div class="creator-spine__text">企画・開発２課</div>${profileEye}</div><div class="creator-spine creator-spine--bio creator-spine--bio-a"><span class="creator-spine__label">自己紹介</span><div class="creator-spine__text">複数の地域イベントを</div>${profileEye}</div><div class="creator-spine creator-spine--bio creator-spine--bio-b"><div class="creator-spine__text">企画運営しています。</div>${profileEye}</div><div class="creator-spine creator-spine--bio creator-spine--bio-c"><div class="creator-spine__text">場づくりが好きです。</div>${profileEye}</div></div>`;
const profileHook = runtimeReplace('</head>','<style>'+profileCss+'</style></head>') + runtimeReplace('</h1>',profileHtml);
