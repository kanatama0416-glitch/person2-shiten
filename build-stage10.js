...
const bookCoverCss = `.cover.cover--photo{padding:20px;position:relative;overflow:visible}.book-cover-photo{display:block;width:auto;height:auto;max-width:100%;max-height:100%;object-fit:contain}.cover--photo .num{top:auto;bottom:-21px}`;
