...
const contentReplacements = [
  ...
  [`<div class="cover"><div class="mock m2"><strong>ONSEN</strong></div></div><b class="num">2</b>`,`<div class="cover"><div class="mock m2 real-cover"><img class="book-cover-photo" src="./book-covers/book_cover_28.png" alt="『デコレータークラブ』の表紙"></div></div><b class="num">2</b>`],
  ...
  [`<div class="cover"><div class="mock m3"><strong>BLUELAND</strong></div></div><b class="num">3</b>`,`<div class="cover"><div class="mock m3 real-cover"><img class="book-cover-photo" src="./book-covers/book_cover_29.png" alt="『縄張りと島』の表紙"></div></div><b class="num">3</b>`],
  ...
  [`<div class="cover"><div class="mock m4"><strong>FIREBALL</strong></div></div><b class="num">4</b>`,`<div class="cover"><div class="mock m4 real-cover"><img class="book-cover-photo" src="./book-covers/book_cover_30.png" alt="『共にいることの可能性、その試み、その記録』の表紙"></div></div><b class="num">4</b>`],
  ...
  [`<div class="cover"><div class="mock m5"><strong>EARLY WORKS</strong></div></div><b class="num">5</b>`,`<div class="cover"><div class="mock m5 real-cover"><img class="book-cover-photo" src="./book-covers/book_cover_31.png" alt="『リー・ミンウェイとその関係展』の表紙"></div></div><b class="num">5</b>`],
