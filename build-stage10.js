...
const contentReplacements = [
  ...
  [`<strong>GENKYO</strong>`,`<strong>目［mé］</strong>`],
  ...
  [`<strong>ONSEN</strong>`,`<strong>飯川雄大</strong>`],
  ...
  [`<strong>BLUELAND</strong>`,`<strong>加藤翼</strong>`],
  ...
  [`<strong>FIREBALL</strong>`,`<strong>田中功起</strong>`],
  ...
  [`<strong>EARLY WORKS</strong>`,`<strong>李明維</strong>`],
...
const profileHook = "html=html.replace('</head>',\"<style>.creator-signature{display:flex;flex-direction:row-reverse;align-items:flex-end;justify-content:center;gap:3px;width:max-content;max-width:100%;margin:22px auto 0;padding:5px 5px 7px}.creator-spine{flex:none;position:relative;display:flex;flex-direction:column;align-items:center;justify-content:space-between;width:36px;height:224px;padding:12px 4px 10px;border:3px solid var(--k);border-radius:7px 7px 4px 4px;box-shadow:3px 3px 0 var(--k);background:#fff;transform-origin:bottom center}.creator-spine__text{writing-mode:vertical-rl;text-orientation:mixed;white-space:nowrap;font-size:13px;line-height:1.45;font-weight:800;letter-spacing:.02em;text-align:start;flex-shrink:0}.creator-spine__text span{text-combine-upright:all}.creator-spine__label{position:absolute;top:9px;left:0;right:0;text-align:center;font-size:9px;line-height:1.2;font-weight:800;letter-spacing:.04em;writing-mode:horizontal-tb}.creator-spine--name .creator-spine__text,.creator-spine--role .creator-spine__text,.creator-spine--bio .creator-spine__text{margin-top:20px}.creator-spine__icon{display:block;flex:none;width:21px;height:21px;fill:none;stroke:currentColor;stroke-width:2.2;stroke-linecap:round;stroke-linejoin:round}.creator-spine--name{height:194px;width:46px;background:var(--p);transform:rotate(2deg)}.creator-spine--name .creator-spine__text{font-size:16px;font-weight:900;letter-spacing:.1em}.creator-spine--role{height:226px;background:#fff;transform:rotate(-1deg)}.creator-spine--role-alt{height:210px;transform:rotate(1deg)}.creator-spine--bio{width:44px;background:var(--k);color:#fff;transform:rotate(-2deg)}.creator-spine--bio-a{height:250px}.creator-spine--bio-b{height:232px;transform:rotate(1deg)}.creator-spine--bio-c{height:214px;transform:rotate(-1deg)}.creator-spine--bio .creator-spine__text{font-weight:700;line-height:1.5;letter-spacing:0;font-size:13px}@media(max-width:340px){.creator-signature{gap:2px;padding-left:2px;padding-right:2px}.creator-spine{width:34px}.creator-spine--name{width:42px}.creator-spine--bio{width:40px}.creator-spine__text{font-size:12px}.creator-spine--name .creator-spine__text{font-size:15px}}</style></head>\");html=html.replace('</h1>',\"</h1><div class=\"creator-signature\" aria-label=\"この視点を書いた人\"><div class=\"creator-spine creator-spine--name\"><span class=\"creator-spine__label\">名前</span><div class=\"creator-spine__text\">むらかみ</div><svg class=\"creator-spine__icon\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M3 12c4-7 14-7 18 0-4 7-14 7-18 0Z\"/><circle cx=\"12\" cy=\"12\" r=\"3\" fill=\"currentColor\"/></svg></div><div class=\"creator-spine creator-spine--role\"><span class=\"creator-spine__label\">所属</span><div class=\"creator-spine__text\">カード事業部</div><svg class=\"creator-spine__icon\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M3 12c4-7 14-7 18 0-4 7-14 7-18 0Z\"/><circle cx=\"12\" cy=\"12\" r=\"3\" fill=\"currentColor\"/></svg></div><div class=\"creator-spine creator-spine--role creator-spine--role-alt\"><div class=\"creator-spine__text\">企画・開発２課</div><svg class=\"creator-spine__icon\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M3 12c4-7 14-7 18 0-4 7-14 7-18 0Z\"/><circle cx=\"12\" cy=\"12\" r=\"3\" fill=\"currentColor\"/></svg></div><div class=\"creator-spine creator-spine--bio creator-spine--bio-a\"><span class=\"creator-spine__label\">自己紹介</span><div class=\"creator-spine__text\">複数の地域イベントを</div><svg class=\"creator-spine__icon\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M3 12c4-7 14-7 18 0-4 7-14 7-18 0Z\"/><circle cx=\"12\" cy=\"12\" r=\"3\" fill=\"currentColor\"/></svg></div><div class=\"creator-spine creator-spine--bio creator-spine--bio-b\"><div class=\"creator-spine__text\">企画運営しています。</div><svg class=\"creator-spine__icon\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M3 12c4-7 14-7 18 0-4 7-14 7-18 0Z\"/><circle cx=\"12\" cy=\"12\" r=\"3\" fill=\"currentColor\"/></svg></div><div class=\"creator-spine creator-spine--bio creator-spine--bio-c\"><div class=\"creator-spine__text\">場づくりが好きです。</div><svg class=\"creator-spine__icon\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M3 12c4-7 14-7 18 0-4 7-14 7-18 0Z\"/><circle cx=\"12\" cy=\"12\" r=\"3\" fill=\"currentColor\"/></svg></div></div>\");"
