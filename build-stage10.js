...
const contentReplacements = [
  ...
  [`<div class="cover"><div class="mock m1"><strong>GENKYO</strong></div></div><b class="num">1</b>`,`<div class="cover cover--photo"><img class="book-cover-photo" src="./book-covers/book_cover_27.png" alt="『非常にはっきりとわからない』の表紙"><b class="num">1</b></div>`],
  ...
  [`<div class="cover"><div class="mock m2"><strong>ONSEN</strong></div></div><b class="num">2</b>`,`<div class="cover cover--photo"><img class="book-cover-photo" src="./book-covers/book_cover_28.png" alt="『デコレータークラブ』の表紙"><b class="num">2</b></div>`],
  ...
  [`<div class="cover"><div class="mock m3"><strong>BLUELAND</strong></div></div><b class="num">3</b>`,`<div class="cover cover--photo"><img class="book-cover-photo" src="./book-covers/book_cover_29.png" alt="『縄張りと島』の表紙"><b class="num">3</b></div>`],
  ...
  [`<div class="cover"><div class="mock m4"><strong>FIREBALL</strong></div></div><b class="num">4</b>`,`<div class="cover cover--photo"><img class="book-cover-photo" src="./book-covers/book_cover_30.png" alt="『共にいることの可能性、その試み、その記録』の表紙"><b class="num">4</b></div>`],
  ...
  [`<div class="cover"><div class="mock m5"><strong>EARLY WORKS</strong></div></div><b class="num">5</b>`,`<div class="cover cover--photo"><img class="book-cover-photo" src="./book-covers/book_cover_31.png" alt="『リー・ミンウェイとその関係展』の表紙"><b class="num">5</b></div>`],
...
const bookCoverCss = `.cover.cover--photo{height:auto!important;min-height:0;padding:12px;position:relative;overflow:visible}.book-cover-photo{display:block;width:auto;height:auto;max-width:100%}.cover--photo .num{top:auto;bottom:-21px}`;
...
const profileEye = `<svg class="creator-spine__icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M3 12c4-7 14-7 18 0-4 7-14 7-18 0Z"/><circle cx="12" cy="12" r="3" fill="currentColor"/></svg>`;
const profileHtml = `</h1><div class="creator-signature" aria-label="この視点を書いた人"><div class="creator-spine creator-spine--name"><span class="creator-spine__label">名前</span><div class="creator-spine__text">むらかみ</div>${profileEye}</div><div class="creator-spine creator-spine--role"><span class="creator-spine__label">所属</span><div class="creator-spine__text">カード事業部</div>${profileEye}</div><div class="creator-spine creator-spine--role creator-spine--role-alt"><div class="creator-spine__text">企画・開発２課</div>${profileEye}</div><div class="creator-spine creator-spine--bio creator-spine--bio-a"><span class="creator-spine__label">自己紹介</span><div class="creator-spine__text">複数の地域イベントを企画運営しています。</div>${profileEye}</div><div class="creator-spine creator-spine--bio creator-spine--bio-c"><div class="creator-spine__text">場づくりが好きです。</div>${profileEye}</div></div>`;
...
console.log('Built and validated shared room/page pet renderer v15 with real book covers.');