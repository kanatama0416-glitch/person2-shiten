...
const profileHtml = `</h1><div class="creator-signature" aria-label="この視点を書いた人"><div class="creator-spine creator-spine--name"><span class="creator-spine__label">名前</span><div class="creator-spine__text">たくや</div>${profileEye}</div><div class="creator-spine creator-spine--role"><span class="creator-spine__label">所属</span><div class="creator-spine__text">カード企画開発</div>${profileCard}</div><div class="creator-spine creator-spine--bio creator-spine--bio-a"><span class="creator-spine__label">自己紹介</span><div class="creator-spine__text">複数の地域イベントを企画運営しています</div>${profileEvent}</div></div>`;
