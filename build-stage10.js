...
const contentReplacements = [
  ...
  [`<section class="essay"><span class="secret-eye" aria-hidden="true"></span><p>同じ景色を見ていても、誰もが同じものを見ているわけではありません。ある人にはただの路地に見える場所が、別の人には記憶や物語の入口に見える。偶然起きた出来事を失敗と捉える人もいれば、そこに新しい表現の可能性を見つける人もいます。</p><p>私にとって「視点」とは、目の前にあるものをどう見るかだけではなく、<span class="hl">そこから何を見つけ、何を意味のあるものとして拾い上げるかを決めるもの</span>です。</p><p>アートに触れる面白さの一つは、自分とは違う誰かの視点を一時的に借りられることだと思います。その人が何を見つめ、何に引っかかり、どんなものに価値を見出しているのかを知ることで、それまで自分の世界には存在していなかったものが、少しずつ見えるようになる。</p><p>そして一度見えるようになったものは、作品の前を離れても残り続けます。何気ない路地や室外機、偶然の出来事、人との出会い。それまで背景だったものが、急に輪郭を持ちはじめる。</p><p>私にとって視点が広がるとは、知識が増えることだけではありません。世界の中に「気づけるもの」が増えていくことです。アートとの出会いによって、同じ日常が以前より細かく、複雑に、面白く見えるようになる。そんなふうに世界の解像度を広げてくれる視点を、この本たちから受け取ってきました。</p></section>`,`<section class="essay"><span class="secret-eye" aria-hidden="true"></span><p>アートと聞くと、美術館の壁に飾られた絵画を静かに眺める姿を思い浮かべるかもしれません。しかし、作品そのものを見るだけでなく、観客自身が中に入り込んで体を動かしたり、見知らぬ誰かと力を合わせたりすることで初めて完成する「体験やルール」のようなアートも存在します。私自身、二子玉川ビエンナーレや世田谷パン祭りといった地域イベントの企画・運営に約20年携わってきました。その活動を長く続けている原点・理由は、人が能動的に関わり、面白がることで、誰にも予想できなかった熱い場が立ち現れる瞬間に立ち会えること・その面白さです。今回選んだ5冊は、人と人とが関わり合い、互いの世界を豊かに広げていくアートの熱量に出会える本です。</p></section>`],
  ...
  [`<span class="artist">横尾忠則</span><h3>『GENKYO 横尾忠則 原郷から幻境へ、そして現況は？』</h3><p>グラフィックデザイナー時代から画家としての作品まで、横尾忠則の表現を幅広く見ることができる一冊です。まずは作品そのものを通して、「横尾忠則は世界をどう見ているのか」を視覚的に感じられる本として選びました。</p>`,`<span class="artist">目［mé］</span><h3>『非常にはっきりとわからない』</h3><p>宇都宮の空に巨大な「実在するおじさんの顔の気球」を浮かび上がらせるなど、日常の景色を一変させてしまう現代アートチームです。そのプロジェクトに心惹かれて参加したトークイベントで、彼らが明かした裏話に大笑いしました。当初は怪訝な顔をしていた地元住民たちの集会所や飲み屋に通いつめ、何か月もかけて信頼を築き、やがて街全体を巻き込むお祭りのような大事件へ進化していった泥臭いプロセスを聞き、深く感動して涙しました。遠くから眺めるお行儀の良い美術品ではなく、作り手と街の人たちの境界線が溶け合い、誰もが当事者になっていく熱狂が詰まった、日常をひっくり返すエネルギーに満ちた一冊です。</p>`],
  [`<div class="cover"><div class="mock m2"><strong>ONSEN</strong></div></div><b class="num">2</b>`,`<div class="cover"><div class="mock m2 real-cover"><img class="book-cover-photo" src="./book-covers/book_cover_28.png" data-cover-source="local" alt="『デコレータークラブ』の表紙"></div></div><b class="num">2</b>`],
  [`<span class="artist">横尾忠則</span><h3>『温泉主義』</h3><p>横尾忠則が訪れた温泉地での出来事と、そこから生まれた絵を一緒に見ることができます。個人的な記憶や経験が、どのように作品へとつながっていくのか。その人が見たものと、描いたものの間をたどることができる一冊です。</p>`,`<span class="artist">飯川雄大</span><h3>『デコレータークラブ』</h3><p>作品の意図や知性に触れて以来、大ファンになった作家です。彼の展示空間には、大きすぎてスマホの画面にどうしても収まらないピンク色の巨大な猫の彫刻が置かれていたり、床に砂がぎっしり詰まった異様に重いリュックサックが無造作に放置されていたりします。「これはいったい何だろう？」と観客が思わず近づき、持ち上げようとしてよろめいたり驚いたりする、その身体の反応やざわめきそのものが作品の一部になります。ただ受動的に眺めるのではなく、人が自ら動いて関わることで初めて空間の仕掛けやタネ明かしが成立する。鑑賞者を「ただのお客さん」から「企ての共犯者」へと変えてしまう、ユーモアと鋭い批評性に満ちたアートの記録です。</p>`],
  ...
  [`<span class="artist">横尾忠則</span><h3>『ぶるうらんど』</h3><p>横尾忠則が初めて小説という形式に挑んだ作品です。絵の中に現れていた幻想的な世界が、今度は文章として立ち上がってきます。「見る横尾忠則」だけでなく、「読む横尾忠則」から、その視点に触れられる本として選びました。</p>`,`<span class="artist">加藤翼</span><h3>『縄張りと島』</h3><p>2014年、私が実行委員を務めたアートイベントで加藤さんをお招きし、駅前広場で巨大な木造構造物を引き起こすプロジェクトを実施しました。地面に横倒しになった家が一軒。そこに何十本ものロープを結び、集まった見知らぬ観客たちが一斉に力を込めて引っ張ります。ロープを握る手を通して周囲の人たちの筋力や熱気がぶるぶると伝わり、全員の息が揃って家が丸ごとドカーンと起き上がった瞬間、広場全体に地鳴りのような大拍手と歓声が湧き起こりました。「みんなで力を合わせる」というシンプルな身体の協働が、人と人とのフィジカルな連帯や、「倒れてしまったものを起こすことができた」という復興の祈りにも似た達成感を実感させてくれる、私の原点とも重なる一冊です。</p>`],
  ...
  [`<span class="artist">蔡國強</span><h3>『原初火球』</h3><p>火薬の爆発によって作品をつくる蔡國強。人が意図したものと、完全には制御できない爆発の偶然性を組み合わせ、その制作過程まで含めて作品としています。「作者がすべてを決める」という見方とは異なる、偶然を受け入れる視点に惹かれて選びました。</p>`,`<span class="artist">田中功起</span><h3>『共にいることの可能性、その試み、その記録』</h3><p>「9人の美容師が1人の客の髪を同時に切る」や「複数の陶芸家が1つの壺を一緒に作る」など、あえて不条理で難しいルールを設定し、集まった人たちがどうやって一つのことを成し遂げるかを観察・記録した実験的な作品集です。他人と一緒に何かをしようとすると、気まずい沈黙が流れたり、意見がぶつかったり、思い通りにいかず失敗したりします。しかし、その摩擦の先にふと互いが通じ合う奇跡のような瞬間が訪れます。地域のイベントや場づくりの現場で誰もが直面する「人間関係のリアルな摩擦」から目を背けず、他者と共に何かを編み上げることの難しさと、だからこそ生まれるかけがえのない価値を静かに教えてくれます。</p>`],
  ...
  [`<span class="artist">蔡國強</span><h3>初期作品の図録</h3><p>蔡國強が若手だった頃の火薬作品が収録された図録です。いわき回廊美術館を訪れた際、蔡國強と長く活動してきた方と偶然出会い、「蔡さんのアートが好きなら」と譲っていただきました。作品だけでなく、人や土地との出会いまで含めて、私自身の蔡國強を見る視点を広げてくれた一冊です。</p>`,`<span class="artist">李明維（リー・ミンウェイ）</span><h3>『リー・ミンウェイとその関係展』</h3><p>10年ちょっと前に六本木の森美術館で鑑賞し、来日した作家本人のトークにも参加した思い出深い展覧会の図録です。見知らぬ誰かに感謝や謝罪の手紙を書く静かな個室、知らない誰かとベッドを並べて寝落ちしながら語り合う空間、持ち寄った破れた服を糸で繕ってもらいながら対話を交わす場など、展示室には人と人が心を通わせるための繊細な仕掛けが用意されていました。作家が提供しているのは飾るための「モノ」ではなく、他者と出会い言葉を交わす「きっかけ」そのものです。大勢で声を上げて綱を引くような熱狂とは対照的な、日常のすぐ隣でそっと見知らぬ誰かと心を通わせる、あたたかで静かな関係性のアートに触れられる記録です。</p>`]
];
const contentHook = '/* CONTENT_02_TAKUYA_DEPLOY_V3 */'+contentReplacements.map(pair=>runtimeReplace(pair[0],pair[1])).join('');
...
const profileHtml = `</h1><div class="creator-signature" aria-label="この視点を書いた人"><div class="creator-spine creator-spine--name"><span class="creator-spine__label">名前</span><div class="creator-spine__text">たくや</div>${profileEye}</div><div class="creator-spine creator-spine--role"><span class="creator-spine__label">所属</span><div class="creator-spine__text">カード企画開発</div>${profileCard}</div><div class="creator-spine creator-spine--bio creator-spine--bio-a"><span class="creator-spine__label">自己紹介</span><div class="creator-spine__text">複数の地域イベントを<br>企画運営しています</div>${profileEvent}</div></div>`;
...
console.log('Built and validated shared room/page pet renderer v18 with all-local book covers.');